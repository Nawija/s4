    ...
    return (
        <Layout>
            <div className="relative flex-center flex-col z-0">
                <div className="relative h-52 md:h-96 w-full -z-10">
                    <LiveSquares />
                ...
                <section class="container max-w-screen-xl -mt-10 lg:-mt-20 mb-6 md:mb-24 mx-auto">
                                ...
                                <div class="rounded-lg shadow-xl h-full block bg-white/60 backdrop-blur-xl w-[90%] sm:w-[90%] lg:w-full mx-auto px-4">
                                    ...
                                    <div class="px-2 py-6 sm:px-6">
                                        ...
                                        <p>
                                            ...
                                            GatsbyJS tworzymy strony
                                            internetowe, które działają bardzo
                                            szybko. Nasze strony ładują się w
                                            mgnieniu oka, co przekłada się na
                                ...
                                <div class="rounded-lg shadow-xl h-full block bg-white/60 backdrop-blur-xl w-[90%] sm:w-[90%] lg:w-full mx-auto px-4">
                                    ...
                                    <div class="px-2 py-6 sm:px-6">
                                        ...
                                        <p>
                                            ...
                                            internetowe wsparcie 24/7 to
                                            kluczowe rozwiązanie. Dzięki temu
                                            klienci otrzymują szybką i
                                            profesjonalną pomoc w przypadku
                                ...
                                <div class="rounded-lg shadow-xl h-full block bg-white/60 backdrop-blur-xl w-[90%] sm:w-[90%] lg:w-full mx-auto px-4">
                                    ...
                                    <div class="px-2 py-6 sm:px-6">
                                        ...
                                        <p>
                                            ...
                                            SEO i pozycjonowania w
                                            wyszukiwarkach, a także na poprawę
                                            jakości użytkowania dla
                                            odwiedzających.
                                        </p>
                                    </div>
                                </div>
