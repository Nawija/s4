    ...
    return (
        ...
        >
            <div className="mx-auto px-2 py-2 lg:py-3 top-0 max-w-screen-2xl flex-between">
                    ...
                    >
                        ...
                        <defs>
                            ...
                            >
                                ...
                                <stop offset="0.5224" stopColor="#F6DAAF" />
                                <stop offset="1" stopColor="#FF932F" />
                            </linearGradient>
                        </defs>
                    </svg>

                    <p className="-tracking-wider logo-color font-bold text-lg font-sans">
                        Seovileo
                    </p>
                </Link>
                ...
                <button
                    onClick={handleMenu}
                    className={`p-2 lg:hidden transition-transform ${
                        showMenu ? "rotate-180 scale-75" : "rotate-0 scale-100"
                    }`}
                    aria-label="menu"
                    title="Menu"
                >
                    {showMenu ? (
                        <svg
                            ...
                            xmlns="http://www.w3.org/2000/svg"
                        >
                            <g clip-path="url(#clip0_1785_168)">
                                <path d="M2 3L26 27Z" fill="black" />
                                <path
                                    d="M2 3L26 27"
                                    stroke="#282A3B"
                                    stroke-width="3"
                        ...
                        >
                            ...
                            <path
                                ...
                                className={`transition-opacity fill-[#ffae00] ${
                                    showMenu ? "opacity-0" : "opacity-100"
                                }`}
                            />
                            <path
                ...
                <ul
                    className={
                        showMenu
                            ? "absolute bg-white z-50 space-y-7 top-full left-0 shadow-lg py-12 w-full text-center font-bold text-[16px] translate-x-0 transition-all opacity-100"
                            : "absolute lg:static bg-white lg:bg-transparent z-50 space-y-7 lg:space-y-0 top-full left-0 shadow-lg py-12 lg:py-4 opacity-0 lg:opacity-100 w-full text-center font-bold lg:text-[15px] -translate-x-full lg:translate-x-0 lg:flex lg:w-max lg:shadow-none lg:font-semibold transition-all"
                    }
                >
                    <li>
                        <Link
                            onClick={closeMenu}
                            className="hover-link px-2 py-2"
                            aria-label="Home"
                            title="Home"
                            to="/"
                        >
